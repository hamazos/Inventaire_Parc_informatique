<?php 
    include('function/stat_port.php'); 
    include_once('include/head.php');      
?> 
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class="fas fa-laptop"></i>PC Portable</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">PC Portable</li>
            </ol>
            <div class="row">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <div class="row">
                        <a href="#addnew" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span><i class="fas fa-plus"></i> Ajouter Pc Portable</a>
                        <a href="#" class="btn btn-success"style="position: absolute;right: 25px;"onclick="pop_up('Portable/print_pdf.php');"><span class="glyphicon glyphicon-print"></span><i class="fas fa-file-pdf"></i> exporter PDF</a>
                    </div>
                            ...
                            <tbody>                                           
                                <?php
                                    ...
                                    while($row = $query->fetch_assoc()){
                                        ...
                                        include('Portable/edit_delete_modal.php');
                                    }
                                ?>
                            </tbody>
                        </table>
...
<?php 
    include('Portable/add_modal.php');
