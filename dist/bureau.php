<?php 
    include('function/stat_bur.php'); 
    include_once('include/head.php');      
?> 
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid">
            <h1 class="mt-4"><i class="fas fa-desktop"></i>PC Bureau</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item active">PC Bureau</li>
            </ol>                        
            <div class="row">
                            ...
                            <tbody> 
                                <?php
                                    ...
                                    while($row = $query->fetch_assoc()){
                                        ...
                                        include('Bureau/edit_delete_modal.php');
                                    }
                                ?> 
                            </tbody>
                        </table>
