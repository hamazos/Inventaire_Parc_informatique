...
<div class="modal fade" id="editimpri_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="maintenance/maint_imprimante.php">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="maint_impri" class="btn btn-success"onclick="pop_up('maintenance/BON_Sortie.php');"><span class="glyphicon glyphicon-check"></span> Update</a>
			</form>
            </div>
